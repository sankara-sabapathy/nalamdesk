...
Documentation: Always update Nalamdesk document with all major and minor changes for both user and developer guides to keep it relevant and up to date. All architecture changes, implementation, setup for developer. All feature, options section for user guide.