...
contextBridge.exposeInMainWorld('electron', {
    ...
    db: {
        ...
        beginConsultation: (input: any) => ipcRenderer.invoke('db:beginConsultation', input),
        getActiveConsultation: (patientId: number) => ipcRenderer.invoke('db:getActiveConsultation', patientId),
        saveConsultationProgress: (input: any) => ipcRenderer.invoke('db:saveConsultationProgress', input),
        completeConsultation: (input: any) => ipcRenderer.invoke('db:completeConsultation', input),
        postponeConsultation: (input: any) => ipcRenderer.invoke('db:postponeConsultation', input),
        resumeConsultation: (input: any) => ipcRenderer.invoke('db:resumeConsultation', input),
        beginNextConsultation: (input: any) => ipcRenderer.invoke('db:beginNextConsultation', input),
        ...
        getEncounterVitals: (encounterId: number) => ipcRenderer.invoke('db:getEncounterVitals', encounterId),
        getVitalsHistory: (patientId: number, visitId?: number) => ipcRenderer.invoke('db:getVitalsHistory', patientId, visitId),
